...
f = open("/home/hsh060824/seokhee/교육/학년/2학년/Qwerty/covid/crawlT.txt", 'w')
f.write(time.strftime('%Y-%m-%d', time.localtime(time.time())))
f.close()

# 오픈 API 아이디, 비번 (최초 설정 후 건드리지 말 것)
client_id = "QrGdEUNRU25WNfN3Bc3R"
client_secret = "cEwgxAlkQa"
...
display = 10 # 각 키워드 당 검색해서 저장할 기사 수
